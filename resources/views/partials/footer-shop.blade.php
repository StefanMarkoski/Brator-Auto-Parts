            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6">
                    <div class="brator-footer-top-element brator-footer-top-address">
                        ...
                        <div class="brator-footer-top-content">
                            <p>Call us 24/7</p><a class="call-top-p" href="#_">1800 500 1234 925</a>
                            <p>Bald Hill St, Asheville, NC 28803</p><a class="e-mail-to" href="#_">info@brator.com</a><img class="tru-img lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/assets/images/footer/trust.png" alt="logo" />
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-lg-6">
                    <div class="brator-footer-top-element">
                        ...
                        <div class="brator-footer-top-content brator-link-list-one"><a href="#_">Help Center</a><a href="#_">My Account</a><a href="#_">Track My Order</a><a href="#_">Return Policy</a><a href="#_">Gift Cards</a><a href="#_">Buy Wholesale</a><a href="#_">FAQ</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="brator-copyright-area">
                        <p>© 2022<a href="#_">Brator Inc.</a>All Rights Reserved</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="brator-payment-area svg-link">
                        <h6 class="brator-payment-title">Payment Methods</h6><a href="#_"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/assets/images/footer/paypal.png" alt="logo" /></a><a href="#_"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/assets/images/footer/master.png" alt="logo" /></a><a href="#_"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/assets/images/footer/visa.png" alt="logo" /></a><a href="#_"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/assets/images/footer/stripe.png" alt="logo" /></a><a href="#_"><img class="lazyload" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="  data-src="/assets/images/footer/klarna.png" alt="logo" /></a>
                    </div>
                </div>
